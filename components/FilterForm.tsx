  ...
  return (
    <div className="">
      ...
      {filterPopUpIsOpen && (
        <div
          ref={FilterPopUp}
          className="absolute left-0 min-w-0  max-w-max z-30 bg-white p-4 border border-gray-500 mt-1 rounded-md"
        >
              ...
              <li>
                ...
                {propertyTypePopUpIsOpen && (
                  <ul
                    ...
                    className="border absolute left-0 rounded-md px-4 mt-[2px] pt-6 pb-6 z-10  bg-white  flex max-lg:justify-center flex-wrap gap-x-1 gap-y-4 max-w-[29rem]"
                  >
                    <li>
                      <input
                        type="checkbox"
              ...
              <li>
                ...
                <div>
                  {PricePopUpIsOpen && (
                    <ul
                      ref={pricePopUp}
                      className="border-2  gap-2 rounded-md absolute left-0  mt-[2px] z-10 pt-2 pb-6  bg-white  px-4 w-fit"
                    >
                      <li>
