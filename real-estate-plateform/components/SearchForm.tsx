...
export default function SearchForm({
  ...
  return (
    <>
      <form action="" method="post" onSubmit={handleSubmit} className="516px:max-sm:px-[3rem] ">
        <ul className="flex max-sm:items-center flex-col   gap-1">
          <li>
            <ul className="flex max-sm:justify-center  flex-wrap gap-1  ">
              <li key="country">
                <input
                  name="country"
          ...
          <div
            ...
            }  flex-wrap items-center gap-1 max-sm:justify-center`}
          >
            <li key="bedAndBaths">
              <button
                type="button"
            ...
            <li key="hashtag" className="sm:hidden">
              <div
                className={`Input ${
                  extraOptions ? "flex" : "hidden"
                } items-center max-sm:w-[10rem] `}
              >
                <span className="pr-4">
                  <FontAwesomeIcon
