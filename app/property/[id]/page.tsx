    ...
    <div className="Container">
      <Container>
        <div className="  flex justify-between ">
            ...
            <div className="text-gray-500">
              <div className="py-4" >
                <div className="flex justify-between flex-wrap w-full">
                  <span className="font-semibold text-[1.5rem] font-rubik text-black ">Title of the property</span>
              ...
              <div  className="flex  justify-between py-4 lg:px-4 max-md:flex-col max-md:items-center gap-x-8 gap-y-4">
                <ul className="w-full sm:w-[70%] lg:w-[50%]max-sm:w-full flex flex-col gap-y-2 min-w-[0] ">
                  <li className="flex flex-wrap justify-between"><span className="text-black font-roboto font-semibold text-[1rem]">Counry</span><span>Morocco</span></li>
                  <li className="flex flex-wrap justify-between"><span className="text-black font-roboto font-semibold text-[1rem]">City</span><span>Oujda</span></li>
                  <li className="flex flex-wrap justify-between"><span className="text-black font-roboto font-semibold text-[1rem]">Address</span><span>Rue atlas lot talhaoui nr 15 oujda</span></li>
                  <li className="flex flex-wrap justify-between"><span className="text-black font-roboto font-semibold text-[1rem]">Type</span><span>Appartement</span></li>
                  <li className="flex flex-wrap justify-between"><span className="text-black font-roboto font-semibold text-[1rem]">Beds</span><span>2</span></li>
                  <li className="flex flex-wrap justify-between"><span className="text-black font-roboto font-semibold text-[1rem]">Baths</span><span>3</span></li>
                  <li className="flex flex-wrap justify-between"><span className="text-black font-roboto font-semibold text-[1rem]">Meublemnt</span><span>Not-meuble</span></li>
                  <li className="flex flex-wrap justify-between"><span className="text-black font-roboto font-semibold text-[1rem]">Surface</span><span>130m²</span></li>
                </ul>
                
                <div className="w-full sm:w-[70%] lg:w-[50%] text-black font-roboto font-semibold text-[1rem] flex flex-wrap justify-between ">
                  <div className="p-0 ">
              ...
              <hr />
              <div className="py-4">
                 <div className="text-black font-roboto font-semibold text-[1rem]"> Description</div>
              ...
              <div className="py-4 w-full ">
                <div className="text-black font-roboto font-semibold text-[1rem] pb-3"> Location on the map :</div>
          ...
          <div className="border border-black min-w-[20rem] ml-1 max-xl:hidden text-center">
            ad panel
          </div>
        </div>
      </Container>
