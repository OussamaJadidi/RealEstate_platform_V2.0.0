  ...
  return (
    <main className="Container max-lg:!px-0  bg-sky-50 font-medium ">
      ...
      <section className="relative w-full h-full flex items-center">
        <div className="min-w-[18rem] z-10 absolute top-[12rem] lg:top-[50%] lg:translate-y-[-50%]  / left-0 max-lg:left-[50%] max-lg:translate-x-[-50%] / max-w-xl p-6 lg:p-8 shadow-xl rounded-md bg-white | flex flex-col">
